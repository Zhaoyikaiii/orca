  ...
  return {
    ...
    terminalLayoutsByTabId:
      ...
      !Array.isArray(input.terminalLayoutsByTabId)
        ? input.terminalLayoutsByTabId
        : {},
    activeWorktreePathsOnShutdown: Array.isArray(input.activeWorktreePathsOnShutdown)
      ? input.activeWorktreePathsOnShutdown.filter(
          (value): value is string => typeof value === 'string'
        )
      : undefined,
    activeTabIdByWorktreePath:
      input.activeTabIdByWorktreePath &&
      typeof input.activeTabIdByWorktreePath === 'object' &&
      !Array.isArray(input.activeTabIdByWorktreePath)
        ? input.activeTabIdByWorktreePath
        : undefined,
    remoteSessionIdsByTabId:
      input.remoteSessionIdsByTabId &&
      typeof input.remoteSessionIdsByTabId === 'object' &&
      !Array.isArray(input.remoteSessionIdsByTabId)
        ? input.remoteSessionIdsByTabId
        : undefined,
    lastVisitedAtByWorktreePath:
      input.lastVisitedAtByWorktreePath &&
      typeof input.lastVisitedAtByWorktreePath === 'object' &&
      !Array.isArray(input.lastVisitedAtByWorktreePath)
        ? input.lastVisitedAtByWorktreePath
        : undefined
  }
}
